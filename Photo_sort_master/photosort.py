...
def main():
        ...
        path = os.path.dirname(r"C:/Users/CHITHRA/Downloads/Photo-Sort-master/Photo-Sort-master") 
        # load the known faces and embeddings
        print("[INFO] loading encodings...")
        data = pickle.loads(open(path + '\\Photo_sort_masterencoding.pickle', "rb").read())
